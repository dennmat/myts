...
class TSExportConfig(BaseModel):
...
def default_and_merge_ts_configs(myts_config: MytsConfiguration) -> TSExportConfig:
	defaults = dict(
	...
	try:
		config = TSExportConfig.model_validate(defaults)
	except ValidationError as e:
		print("Invalid configuration provided for ts export", e)
		sys.exit(65)
